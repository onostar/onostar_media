...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $monthlys = $get_monthly->fetch_monthly_rep_sales($rep);
    ...
    <?php
        //get revenue
        $get_pos = new selects();
        $poss = $get_pos->fetch_sum_double('sales', 'total_amount', 'sales_status', 2, 'posted_by', $rep);
        ...
        $cashs = $get_cash->fetch_sum_double('sales', 'commission', 'sales_status', 2, 'posted_by', $rep);
