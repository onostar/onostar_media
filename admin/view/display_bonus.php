<?php
    ...
    if(isset($_GET['rep'])){
        ...
        //getdetails
        $get_rep = new selects();
        $names = $get_rep->fetch_details_group('users', 'full_name', 'user_id', $rep);
        $sales_rep = $names->full_name;
?>
<button class="page_navs" id="back" onclick="showPage('sales_rep_bonus.php')"><i class="fas fa-angle-double-left"></i> Back</button>
<div id="revenueReport" class="displays management">
    
<div class="displays allResults new_data" id="revenue_report">
    <h2 >Customer Bonus for <?php echo $sales_rep. " in ".date("F, Y")?></h2>
    <hr>
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $monthlys = $get_monthly->fetch_details_curMonCon('bonus', 'post_date', 'sales_rep', $rep);
            ...
            <tr>
                ...
                <td><a style="color:#fff; border-radius:15px; padding:8px; background:green" href="javascript:void(0)" title="View invoice details" onclick="showPage('rep_invoice.php?invoice=<?php echo $monthly->invoice?>')">View <i class="fas fa-eye"></i></a></td>
