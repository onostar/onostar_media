        ...
        <table id="priceTable" class="searchTable">
            ...
            ?>
                <tr>
                    ...
                    <td class="prices">
                        <a style="background:red!important; color:#fff!important; padding:6px; border-radius:5px;" href="javascript:void(0)" data-form="check<?php echo $row->item_id?>" class="each_prices" onclick="deleteItem('<?php echo $row->item_id?>');"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php $n++; endforeach; }?>
