<?php
   ...
   /*  $wholesale = htmlspecialchars(stripslashes($_POST['wholesale_price']));
    ...
    if($stock_in){
        ...
        $update_item->update_multiple('items', 'cost_price', $cost_price, 'sales_price', $sales_price, 'pack_price', $pack_price, 'commission', $commission, /* 'wholesale_pack', $wholesale_pack, */ 'pack_size', $pack_size, 'item_id', $item);
        if($update_item){
        //update expiration
