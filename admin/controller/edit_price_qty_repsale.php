<?php
    ...
    <div class="add_user_form priceForm" style="width:90%; padding:0!important">
        ...
        <h3 style="background:var(--secondaryColor);">Edit quantity and markup for <?php echo strtoupper($name)?></h3>
            <div class="inputs">
                ...
                <div class="data" style="width:20%">
                    <button type="submit" id="change_price" name="change_price" onclick="updatePriceQtyRep()">Update </button>
