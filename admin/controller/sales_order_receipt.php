...
<div class="displays allResults sales_receipt">
    ...
    <?php
        ...
        $get_seller = new selects();
        $row = $get_seller->fetch_details_group('sales', 'posted_by', 'invoice', $invoice);
        $get_user = new selects();
        $details = $get_seller->fetch_details_group('users', 'full_name', 'user_id', $row->posted_by);
        echo ucwords("<p class='sold_by'>Sold by: <strong>$details->full_name</strong></p>");
    ?>
