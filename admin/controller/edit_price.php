<?php
    ...
    // if(isset($_POST['change_prize'])){
        ...
        $commission = htmlspecialchars(stripslashes($_POST['commission']));
    ...
    // $store_name = $strs->store;
        ...
        $change_price->update_multiple('items', 'cost_price', $cost_price, 'sales_price', $sales_price, 'pack_price', $pack_price, 'pack_size', $pack_size, 'commission', $commission, /* 'wholesale_pack', $wholesale_pack, */ /* 'carton_role', $carton_price, 'carton_size', $carton_size, */ 'item_id', $item);
