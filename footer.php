            ...
            <section class="mainFooter1">
                ...
                <div class="socialMedia_workHours">
                    <div class="workingHours">
                        <h3>Working hours</h3>
                        <div class="hours">
                            <p>We are Open Mondays to Saturdays 8:00am to 6:00pm</p>
                        </div>
                    </div> 
                    <div class="category">
                        <h3>Quick Links</h3>
...
<!-- </div> -->
    ...
    <div class="toTop" id="whatsapp_link">
        <a href="https://wa.me/+2347064204157" title="Chat with us" target="_blank"><i class="fab fa-whatsapp"></i></a>
    </div>
    <!-- addvert -->
    <!-- <div class="addverts">
        <div class="close_add">
